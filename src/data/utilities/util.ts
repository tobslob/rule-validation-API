...
export const jSendError = (res: Response, msg: any, code: number, data: any) => {
...
export const jSendFailure = (res: Response, msg: any, code: number, data: any) => {
  res.status(code).json({
    message: msg,
    status: "error",
    data
...
export const jSendSuccess = (_req: Request, res: Response, msg: any, data?: any) => {
  res.status(200).json({
    message: msg,
    status: "success",
    data
